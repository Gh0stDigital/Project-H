...
export const worldPacks: readonly WorldPack[] = [
  ...
  },
  {
    ...
    optionalLocations: ["battle1","battle2","corridor3"],
    events: ["bossDoor","key","rest","roadSign","shrineDoor","trap1","trap2","treasureLocked","treasureMimic","treasureOpened"],
    npcs: ["hunter","merchant","pilgrim","scholar","wanderer"],
  ...
  },
  {
    id: "profane-prison",
    name: "불경한 감옥",
    description: "사슬에 매달린 철창과 금빛 봉인이 새겨진 돌. 이곳에 갇힌 것은 죄수만이 아닙니다.",
    complete: true,
    missing: [],
    locations: ["battle1","bossRoom","corridor1","corridor2","corridor3","corridor4","entrance","keyRoom","pathwayFork","restRoom","shrineRoom","trapRoom","treasureRoom"],
